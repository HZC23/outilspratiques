...
const RESOURCES_TO_CACHE = [
    ...
    // Pages d'outils
    `${BASE_PATH}/html/tools/calculator.html`,
    `${BASE_PATH}/html/tools/timer.html`,
    `${BASE_PATH}/html/tools/stopwatch.html`,
    `${BASE_PATH}/html/tools/note.html`,
    `${BASE_PATH}/html/tools/todo.html`,
    `${BASE_PATH}/html/tools/translator.html`,
    `${BASE_PATH}/html/tools/color.html`,
    `${BASE_PATH}/html/tools/qrcode.html`,
    `${BASE_PATH}/html/tools/password.html`,
    `${BASE_PATH}/html/tools/unit.html`,
    `${BASE_PATH}/html/tools/currency.html`,
